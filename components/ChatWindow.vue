...
<style scoped>
  ...
  .chatWindow__input input[type="text"] {
    width: 100%;
    height: 100%;
  }

  .chatWindow__input input[type="submit"] {
    width: 33px;
    height: 33px;
    flex-shrink: 0;
